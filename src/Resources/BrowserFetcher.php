 ...
 * @method mixed download(string $revision, \NigelCunningham\Rialto\Data\JsFunction $progressCallback = null)
 * @method-extended mixed download(string $revision, callable(float $x, float $y): void|\NigelCunningham\Rialto\Data\JsFunction $progressCallback = null)
